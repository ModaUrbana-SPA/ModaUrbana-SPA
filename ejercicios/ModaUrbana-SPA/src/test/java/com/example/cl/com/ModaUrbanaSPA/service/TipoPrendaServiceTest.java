...
import com.example.cl.com.ModaUrbanaSPA.repository.TipoPrendaRepository;
...
public class TipoPrendaServiceTest {
    ...
    @MockBean
    private TipoPrendaRepository tipoPrendaRepositorio;

    @Test
    public void testFindAll() {
        when(tipoPrendaRepositorio.findAll())
                .thenReturn(List.of(new TipoPrenda(1, "Camisas", "Tipos de camisas formales y casuales")));
